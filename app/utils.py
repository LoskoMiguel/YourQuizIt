...
def generar_preguntas(nivel, cantidad, tiempo):
    print(f"\nGenerando {cantidad} preguntas de nivel {nivel} con el tiempo verbal {tiempo}...\n\n")

    prompt = f"""
    Necesito practicar mi inglés.
    Genera {cantidad} preguntas de inglés de nivel {nivel} y con el tiempo verbal de {tiempo} centradas en gramática y vocabulario.
